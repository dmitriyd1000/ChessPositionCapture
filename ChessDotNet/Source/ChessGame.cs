...
namespace ChessDotNet.Source
{
    public class ChessGame
    {
        ...
        private Dictionary<char, ChessPiece> fenMappings = new Dictionary<char, ChessPiece>()
        {
        ...
        {
            ChessDotNet.GameCreationData data = FenStringToGameCreationData(fen);
            UseGameCreationData(data);
        }

        public ChessGame(ChessDotNet.GameCreationData data)
        {
            UseGameCreationData(data);
        }
        ...
        protected virtual void UseGameCreationData(ChessDotNet.GameCreationData data)
        {
        ...
        protected virtual ChessDotNet.GameCreationData FenStringToGameCreationData(string fen)
        {
            ...
            ChessDotNet.GameCreationData data = new ChessDotNet.GameCreationData();
            for (int i = 0; i < 8; i++)
            {
                string row = rows[i];
        ...
        {
            ChessUtility.ThrowIfNull(move, "move");
            ChessDotNet.GameCreationData gcd = new ChessDotNet.GameCreationData();
            gcd.Board = Board;
